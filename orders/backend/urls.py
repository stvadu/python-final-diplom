...
from .views import SupplierUpdate, ShopView, CategoryView, ProductView, OrderView, OrderCreationView, BasketView, OrderConfirmationView, UserRegisterView, Login, ContactView, welcome
