...
1. [Спецификация (API) - 1 шт.](screens.md)
...
**Базовая часть:**
1. [Создание и настройка проекта.](step-1.md)
2. [Проработка моделей данных.](step-2.md)
3. [Реализация импорта товаров.](step-3.md)
4. [Реализация API views.](step-4.md)
5. [Полностью готовый backend.](step-5.md)

**Продвинутая часть** (выполняется по желанию, если базовая часть полностью готова):

6. [Реализация forms и views админки склада.](step-6-adv.md)
7. [Вынос медленных методов в задачи Celery.](step-7-adv.md)
...
Для получения подробностей по данному этапу
[перейдите по ссылке](step-5.md).

## Полезные материалы

1. [Информация о сервисе](service.md)
2. [Спецификация API](api.md)
3. [Описание страниц сервиса](screens.md)
...
Для получения подробностей по данному этапу
[перейдите по ссылке](step-6-adv.md).
...
Для получения подробностей по данному этапу
[перейдите по ссылке](step-7-adv.md).  
